            ...
            <div className="container" id="addnotecon">
                ...
                <form autoComplete="off">
                    <div className="mb-3" className="addnoteinput">
                        ...
                        <input type="text" className="form-control" name = "title" id="title"  aria-describedby="emailHelp" onChange={onchange} minLength="3" placeholder="Enter atleast 3 characters"/>
                    </div>
                    <div className="mb-3" className="addnoteinput">
                        <label htmlFor="exampleInputPassword1" className="form-label">Description</label>
                        <textarea rows="4" type="text" className="form-control" id="description" placeholder="Enter atleast 5 characters" name="description"onChange={onchange} minLength="5" />
                    </div>
                    <div className="mb-3" className="addnoteinput">
